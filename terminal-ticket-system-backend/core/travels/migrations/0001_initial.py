    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='travels.cities', verbose_name='شهر')),
                ...
                ('province', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='travels.provinces', verbose_name='استان')),
